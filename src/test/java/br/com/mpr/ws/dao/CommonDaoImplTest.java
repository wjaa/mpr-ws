...
public class CommonDaoImplTest extends BaseDBTest {
    ...
    public void get() throws Exception {
        ...
        Assert.assertTrue(DateUtils.formatddMMyyyyHHmmss(testEntity.getTestDate()).equals("30/09/1983 00:00:00"));
        Assert.assertTrue(DateUtils.formatddMMyyyyHHmmss(testEntity.getTestDateTime()).equals("30/09/1983 19:10:02"));
