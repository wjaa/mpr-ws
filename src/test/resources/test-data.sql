...
--PRODUTOS
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA, IMG_DESTAQUE, ATIVO, HEXA_COR, NOME_COR, COMP, LARG, ALT, LANCAMENTO,POPULAR, DESTAQUE,QTDE_FOTOS)
values (1, 1,'PORTA RETRATO','xrp2',1,'IMG2.JPG', 10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1,'FFF', 'BRANCO', 20, 15, 2,1,1,1,1);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, ATIVO, HEXA_COR, NOME_COR, COMP, LARG, ALT, LANCAMENTO,POPULAR,QTDE_FOTOS)
values (2, 1,'PORTA RETRATO 2','btc1',1,'IMG2.JPG',10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1,'DDD', 'CINZA', 20, 15, 2,1,1,1);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, ATIVO, HEXA_COR, NOME_COR, COMP, LARG, ALT, LANCAMENTO,POPULAR,QTDE_FOTOS)
values (3, 1,'PRODUTO TESTE ESTOQUE','TESTE',1,'IMG2.JPG',10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1,'000', 'PRETO', 20, 15, 2,0,1,1);
