...
--PRODUTOS
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_DESTAQUE,IMG_PREVIEW, ESTOQUE_MINIMO)
values (1, 1,'PORTA RETRATO','xrp2',10.10,'IMG.JPG','IMG2.JPG', 10);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_DESTAQUE,IMG_PREVIEW, ESTOQUE_MINIMO)
values (2, 1,'PORTA RETRATO 2','btc1',20.10,'IMG.JPG','IMG2.JPG',10);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_DESTAQUE,IMG_PREVIEW, ESTOQUE_MINIMO)
values (3, 1,'PRODUTO TESTE ESTOQUE','TESTE',20.10,'IMG.JPG','IMG2.JPG',10);
