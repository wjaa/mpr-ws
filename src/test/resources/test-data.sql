...
values (1, 1,'PORTA RETRATO','xrp2',10.10,'IMG.JPG','IMG2.JPG');
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_DESTAQUE,IMG_PREVIEW)
values (2, 1,'PORTA RETRATO 2','btc1',20.10,'IMG.JPG','IMG2.JPG');
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_DESTAQUE,IMG_PREVIEW)
values (3, 1,'PRODUTO TESTE ESTOQUE','TESTE',20.10,'IMG.JPG','IMG2.JPG');
...
insert into ESTOQUE (ID,ID_FORNECEDOR,DATA_COMPRA,DATA_ATUALIZACAO,PRECO_COMPRA,OBSERVACAO)
values(2,1,'2018-01-01','2018-01-01',10,'TESTE_PRODUTO3');
...
--items para o teste de listagem de produtos do estoque
insert into ESTOQUE (ID,ID_FORNECEDOR,DATA_COMPRA,DATA_ATUALIZACAO,PRECO_COMPRA,OBSERVACAO)
values(3,1,'2018-01-01','2018-01-01',10,'TESTE_OUTRO LOTE PRODUTO3');
