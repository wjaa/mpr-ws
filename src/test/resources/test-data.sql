...
--PRODUTOS
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA, IMG_DESTAQUE, ATIVO)
values (1, 1,'PORTA RETRATO','xrp2',10.10,'IMG2.JPG', 10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, ATIVO)
values (2, 1,'PORTA RETRATO 2','btc1',20.10,'IMG2.JPG',10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1);
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, mawati99)
values (3, 1,'PRODUTO TESTE ESTOQUE','TESTE',20.10,'IMG2.JPG',10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1);
