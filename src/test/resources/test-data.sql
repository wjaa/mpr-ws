...
insert into ENDERECO (ID, CEP, LOGRADOURO, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, UF, ID_CLIENTE, ATIVO, DESCRICAO, OBSERVACAO, PRINCIPAL)
values (null,'07093090', 'Rua das porpetas malucas', '132a', 'sem complemento', 'bairro da pizza', 'guarulhos', 'sp', 5, 1, 'principal', 'perto da rua das coxinhas', 1);
...
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, ATIVO, HEXA_COR, NOME_COR)
values (2, 1,'PORTA RETRATO 2','btc1',20.15,'IMG2.JPG',10, 'TESTES TESTE TESTE TESTE','IMG2.JPG',1,'DDD', 'CINZA');
insert into PRODUTO (ID, ID_TIPO_PRODUTO, DESCRICAO,REFERENCIA,PESO,IMG_PREVIEW, ESTOQUE_MINIMO, DESCRICAO_DETALHADA,IMG_DESTAQUE, ATIVO, HEXA_COR, NOME_COR)
