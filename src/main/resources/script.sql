...
CREATE TABLE PRODUTO(
    ...
    IMG_PREVIEW_PAISAGEM VARCHAR(100),
...
CREATE INDEX idx_produto_ref ON produto(ref);
...
CREATE TABLE produto_preview(
    ID INT(28) NOT NULL AUTO_INCREMENT,
    ID_SESSION INT(28),
    ID_CLIENTE INT(28),
    ID_PRODUTO INT(28) NOT NULL,
    FOTO_PREVIEW VARCHAR(200) NOT NULL,
    PRIMARY KEY (ID)
);

CREATE TABLE produto_preview_anexo(
    ID INT(28) NOT NULL AUTO_INCREMENT,
    ID_PRODUTO_PREVIEW INT(28) NOT NULL,
    FOTO VARCHAR(200),
    ID_CATALOGO INT(28),
    PRIMARY KEY (ID)
);
...
CREATE INDEX idx_upload_token ON upload(TOKEN);

CREATE TABLE imagem(
   ID INT (10) NOT NULL AUTO_INCREMENT,
   ID_UPLOAD INT (10) NOT NULL
   IMAGEM_HI VARCHAR(100) NOT NULL,
   IMAGEM_THUMB VARCHAR(100) NOT NULL,
